...
public enum Result implements IdAdapter.HasId {
    ...
    NoConnectionRetry(4, null), // OBSOLETE - removed
    ...
    LogonSessionReplaced(34, null),
    ConnectFailed(35, null),
    HandshakeFailed(36, null),
    IOFailure(37, null),
    RemoteDisconnect(38, null),
    ...
    ExternalAccountAlreadyLinked(59,
            "External account (PSN, Facebook...) is already linked to some other account, must explicitly request to " +
                    "replace/delete the link first"
    ),
    ...
    HardwareNotCapableOfIPT(67, null),
    IPTInitError(68, null),
    ...
    IPLoginRestrictionFailed(72, null),
    AccountLockedDown(73, null),
    AccountLogonDeniedVerifiedEmailRequired(74, null),
    NoMatchingURL(75, null),
    ...
    public static Result findById(int id) {
        if (id < 0 || id >= VALUES.length) {
            throw new NoSuchElementException("Result with the given id does not exist");
        }
